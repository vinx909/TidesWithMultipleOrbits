...
{
    public class TidalHeightBetweenTwoBodies : TideCalculatorTestBase
    {
        [Fact]
        public void CallsGetIdOfOrbitItem()
        {
            sut.TidalHeightBetweenTwoBodies(SystemTwoStar, SystemTwoSataliteOne, 0);
        ...
        public void CallsGetIdOfOrbitItemWithGivenItems()
        {
            ...
            sut.TidalHeightBetweenTwoBodies(satalite, star, 0);
        ...
        public void ReturnsNegativeOne_WhenItemNotInRange()
        {
            ...
            var result = sut.TidalHeightBetweenTwoBodies(SystemTwoStar, SystemTwoSataliteOne, 0);
        ...
        public void ReturnsNegativeOne_WhenItemWithSameId()
        {
            ...
            var result = sut.TidalHeightBetweenTwoBodies(satalite, star, 0);
        ...
        public void CallsGetInt()
        {
            ...
            sut.TidalHeightBetweenTwoBodies(star, satalite, 0);
        ...
        public void ReturnsCorrect_StarOnSatalite()
        {
            ...
            double expected = GetTidalHeight(star.Mass, satalite.Mass, satalite.Radius, distance);
            mockItemsRepository.Setup(m => m.GetIdOf(star)).Returns(star.Id);
            mockItemsRepository.Setup(m => m.GetIdOf(satalite)).Returns(satalite.Id);
        ...
        public void ReturnsCorrect_SataliteOnSataliteStartPosition()
        {
            ...
            double expected = GetTidalHeight(sataliteTwo.Mass, sataliteOne.Mass, sataliteOne.Radius, distance);
            mockItemsRepository.Setup(m => m.GetIdOf(star)).Returns(star.Id);
            ...
            var result = sut.TidalHeightBetweenTwoBodies(sataliteOne, sataliteTwo, 0);
        ...
        public void ReturnsCorrect_SataliteOnSatalite180Degrees()
        {
            ...
            var result = sut.TidalHeightBetweenTwoBodies(sataliteOne, sataliteTwo, 2);
        ...
        public void ReturnsCorrect_SataliteOnSatalite90Degrees()
        {
            ...
            var result = sut.TidalHeightBetweenTwoBodies(sataliteOne, sataliteTwo, 1);
        ...
        public void CallGetIntExpectedAmountsOfTimes_SataliteOnSubSubSataliteComplicated()
        {
            ...
            double expected = GetTidalHeight(sataliteOne.Mass, subSubSatalites.Mass, subSubSatalites.Radius, distance);
            mockItemsRepository.Setup(m => m.GetIdOf(star)).Returns(star.Id);
            mockItemsRepository.Setup(m => m.GetIdOf(sataliteOne)).Returns(sataliteOne.Id);
            mockItemsRepository.Setup(m => m.GetIdOf(sataliteTwo)).Returns(sataliteTwo.Id);
            ...
            sut.TidalHeightBetweenTwoBodies(subSubSatalites, sataliteOne, 1);
        ...
        public void ReturnsCorrect_SataliteOnSubSubSataliteComplicated()
        {
            ...
            var result = sut.TidalHeightBetweenTwoBodies(subSubSatalites, sataliteOne, 1);
