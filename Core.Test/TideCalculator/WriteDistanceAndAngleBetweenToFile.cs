...
namespace Core.Test.TideCalculator
{
    public class WriteDistanceAndAngleBetweenToFile : TideCalculatorTestBase
    {
        ...
        public void InvokesIWriterWriteWithCorrectStrings_StartWithLeadingZeros()
        {
            ...
            var result = sut.WriteDistanceAndAngleBetweenToFile(star, sataliteOne, sataliteTwo, 0, 10, 5);
        ...
        public void InvokesIWriterWriteWithCorrectStrings_Value_Distance()
        {
            ...
            var result = sut.WriteDistanceAndAngleBetweenToFile(sataliteOne, sataliteTwo, star, 0, 3, 1);
