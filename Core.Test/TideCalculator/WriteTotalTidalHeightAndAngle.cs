...
{
    public class WriteTotalTidalHeightAndAngle : TideCalculatorTestBase
    {
        [Fact]
        public void ReturnsFalse_WhenSetWritePathNotSet()
        {
            ...
            var result = sut.WriteTotalTidalHeightAndAngle(star, sataliteTwo, 0, 3, 1);
        ...
        public void InvokesIWriterCanWrite()
        {
            ...
            sut.WriteTotalTidalHeightAndAngle(star, sataliteTwo, 0, 3, 1);
