...
namespace Core.Test.TideCalculator
{
    public class TideCalculatorTestBase
    {
        ...
        public TideCalculatorTestBase()
        {
            ...
            SystemTwoSataliteOne = new() { Id = 5, Mass = 1000, Name = "right triangle B", OrbitingId = 4, Radius = 100, OrbitingDistance = 10000, OrbitPeriod = 2 };
            SystemTwoSataliteTwo = new() { Id = 6, Mass = 1000, Name = "right triangle C", OrbitingId = 4, Radius = 100, OrbitingDistance = 20000, OrbitPeriod = 4 };
            SystemTwoSubSataliteOne = new() { Id = 7, Mass = 10, Name = "rectangle", OrbitingId = 5, Radius = 10, OrbitingDistance = 10000, OrbitPeriod = 4 };
            SystemTwoSubSataliteOne = new() { Id = 8, Mass = 10, Name = "rectangle mid point A", OrbitingId = 5, Radius = 10, OrbitingDistance = 1000, OrbitPeriod = 4 };
            SystemTwoSubSubSatalite = new() { Id = 9, Mass = 1, Name = "rectangle mid point B", OrbitingId = 7, Radius = 1, OrbitingDistance = 1000, OrbitPeriod = 4 };
