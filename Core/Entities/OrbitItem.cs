...
namespace Core.Entities
{
    ...
    {
        private int id = 1;
        private int orbitingId = 0;
        private int mass = 0;
        private int radius = 0;
        private int orbitingDistance = 1;
        private int orbitPeriod = 0;
        ...
        /// </summary>
        public int OrbitingId { get => orbitingId; set { if (value != id && value > -1) { orbitingId = value; } } }

        /// <summary>
        /// mass in kg
        /// </summary>
        public int Mass { get => mass; set { if (value != id && value > -1) { mass = value; } } }

        /// <summary>
        /// radius in meters
        /// </summary>
        public int Radius { get => radius; set { if (value != id && value > -1) { radius = value; } } }

        /// <summary>
        /// distance to the item it's orbiting in meters, must be greater then 0
        /// </summary>
        public int OrbitingDistance { get => orbitingDistance; set { if (value != id && value > 0) { orbitingDistance = value; } } }
        ...
        /// </summary>
        public int OrbitPeriod { get => orbitPeriod; set { if (value != id && value > -1) { orbitPeriod = value; } } }
